    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isFirstLaunch) {
            AlertDialog dialog = new AlertDialog.Builder(this)
                    .setTitle("FROM TEAM ERROR")
                    .setMessage("Welcome to Team_Error's Timetable App! Our app helps you manage your schedule and stay organized with ease. With support for link management and notifications, it's perfect for students, professionals and anyone looking to stay on top of their tasks and events. Thank you for choosing our app!")
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    .show();
            final Button continueBtn = dialog.getButton(AlertDialog.BUTTON_POSITIVE);
