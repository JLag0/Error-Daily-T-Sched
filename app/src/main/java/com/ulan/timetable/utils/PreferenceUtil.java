...
public class PreferenceUtil {
    ...
    public static boolean isSevenDays(Context context) {
        return getBooleanSettings(context, SettingsActivity.KEY_SEVEN_DAYS_SETTING, true);
    }
    ...
    public static int[] getStartTime(Context context) {
        SharedPreferences sharedPref = PreferenceManager.getDefaultSharedPreferences(context);
        return new int[]{sharedPref.getInt("start_hour", 6), sharedPref.getInt("start_minute", 0), sharedPref.getInt("start_second", 0)};
    }
