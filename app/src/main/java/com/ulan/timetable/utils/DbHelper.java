...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void deleteLink(String link) {
        ...
        db.delete(TABLE_NAME, COLUMN_ID + "=?", new String[] {String.valueOf(link)});
    }
    ...
    public void onCreate(@NonNull SQLiteDatabase db) {
        ...
        String CREATE_LINKS = "CREATE TABLE " + TABLE_NAME + " (" +
...
//        db.close();
    ...
    public boolean addLink(String link) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COLUMN_ID, link);
    ...
    public ArrayList<String> getLinks() {
        ...
        Cursor cursor = db.query("links", new String[] { "link" }, null, null, null, null, "id ASC");
        while (cursor.moveToNext()) {
